...
public interface  UploadAPI {
    ...
    Call<ResponseBody> uploadImag(@Header("Authorization") String token, @Part MultipartBody.Part file, @Part("pdt_name") RequestBody pdt_name, @Part("pdt_price") RequestBody pdt_price, @Part("pdt_discount") RequestBody pdt_discount, @Part("stock") RequestBody stock, @Part("pdt_description") RequestBody pdt_description, @Part("id") RequestBody id);
