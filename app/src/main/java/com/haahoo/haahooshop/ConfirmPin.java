...
public class ConfirmPin extends AppCompatActivity {
    ...
    private String Urline = Global.BASE_URL+"api_shop_app/shop_pin_generation/";
    public String pins="";
    ...
    private PinLockListener mPinLockListener = new PinLockListener() {
        ...
        public void onComplete(String pin) {
            ...
            if(sessionManager.getPins().equals(pin)){
                Toast.makeText(ConfirmPin.this,"verified",Toast.LENGTH_SHORT).show();
                submituser();
            }
            if(!(sessionManager.getPins().equals(pin))){
                Toast.makeText(ConfirmPin.this,"Pin mismatch",Toast.LENGTH_SHORT).show();
            }
        }
...
// finally change the color
    ...
    private  void  submituser(){
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(status.equals("200")){
                        ...
                        Toast.makeText(ConfirmPin.this, "Failed."+ot, Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(ConfirmPin.this,error.toString(),Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ConfirmPin.this);
